...
lazy_static! {
    static ref REGEX_MD5: Regex = Regex::new(r#"([a-fA-F0-9]{32})"#).expect("Failed to compile regex!");
    static ref REGEX_SHA256: Regex = Regex::new(r#"([a-fA-F0-9]{64})"#).expect("Failed to compile regex!");
    static ref REGEX_SHA512: Regex = Regex::new(r#"([a-fA-F0-9]{128})"#).expect("Failed to compile regex!");
